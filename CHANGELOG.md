...
- The update notification now downloads updates directly instead of opening the settings page.
- Removed the failing Microsoft Store release job while keeping Windows and Linux release builds.

### Fixed

- Update download failures now show a retry action in the notification and settings update card.
